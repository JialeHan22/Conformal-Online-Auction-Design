# Application-Based Simulation Studies in Section 7.2

This folder contains the implementation and experimental code for our study in Section 7.2, which compares the revenue performance of various auction mechanisms and evaluates the coverage probability of conformal prediction intervals through a polynomial regression-based simulation study.

## Contents

### Main Files

* **`simulation_Section_7.2.ipynb`**
  ...
  * Generation of all plots used in Section 7.2.
...
2. Launch and run the Jupyter notebook `simulation_Section_7.2.ipynb`.
